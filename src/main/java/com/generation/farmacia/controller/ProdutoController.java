...
@RequestMapping("/produtos") // Identifica o endereço para realizar a busca
...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> getAll() {
		...
		// Traga pra mim uma resposta HTTP contendo no corpo da resposta uma estrutura
		// do tipo list contendo todos os produtos encontrados
	}
